...
export function Hero() {
  return (
    <section className="border-b border-border bg-background">
      <div className="mx-auto grid min-h-[calc(100svh-4rem)] w-full max-w-6xl content-center gap-12 px-[var(--container-inline)] py-20 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-end lg:py-28">
        <div className="max-w-4xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a
              href="#work"
              className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-foreground px-4 text-sm font-medium text-background transition-colors hover:bg-muted-foreground"
            >
              View My Work
